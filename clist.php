...
echo'<section id="banner">';
	            ...
	            echo'<h2>ELECTION COMMISSION OF INDIA.</h2>';
							...
							echo'<th>PARTY SIGN</th>';
							echo'<th>AGE</th>';
							echo'<th>GENDER</th>';
							echo'<th>QUALIFICATION</th>';
							echo'<th>CRIMINAL RECORD</th>';
					...
					echo'</tbody>';
					echo'</table>';
echo'TO VOTE PLEASE WRITE THE CANDIDATES ID IN THE BOX BELOW AND CLICK VOTE BUTTON ';
echo'<br/>';


					
					echo'<form action="clist1.php" method="post">';
					echo'<li>';
						echo'<input type="text" name="count" value="1001"  >';
					echo'</li>';
